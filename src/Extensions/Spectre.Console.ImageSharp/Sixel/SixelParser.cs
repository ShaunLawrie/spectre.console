...
namespace Spectre.Console.ImageSharp.Sixel;

/// <summary>
/// Contains methods for converting an image to a Sixel string.
/// </summary>
public static class SixelParser
{
    /// <summary>
    /// Converts an image to a Sixel string.
    /// This uses the pretty quick sixel codec from Renee and Shaun in https://github.com/trackd/Sixel.
    /// The original algorithm has been tweaked to try and make this wedge into the Spectre.Console framework
    /// with minimal changes on the Spectre.Console side.
    /// </summary>
    ...
    public static string ImageToSixel(Image<Rgba32> image, int cellWidth, int frame = 0, bool returnCursorToTopLeft = true)
    {
